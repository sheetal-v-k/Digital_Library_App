...
public class pdf1 extends AppCompatActivity {
    ...
    protected void onCreate( Bundle savedInstanceState ) {
        ...
        if(MyApplication.bookshelf.equals("Explorations in Artificial Intelligence and Machine Learning")){
            pdfaib1.fromAsset("ArtficialIntelligence.pdf").load();
        }
        if(MyApplication.bookshelf.equals("Artificial and Machine Learning")){
            pdfaib1.fromAsset("ArtficialIntelligenceandmachinelearning.pdf").load();
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item ){
        switch(item.getItemId()){
            case R.id.option1:
                ...
                Intent book=new Intent(pdf1.this,pdf2.class);
                startActivity(book);
                return true;
            case R.id.option2:
                Toast.makeText(this, "Review the Book", Toast.LENGTH_SHORT).show();
                Intent review=new Intent(pdf1.this,Review.class);
